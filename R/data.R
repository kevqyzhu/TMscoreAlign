...
#' of the protein ILNIA. This structure was pre-generated by the 3DRobot program
#' developed by the Zhang Lab.
#'
...
#'
#' Correctly formatted PDB file. The PDB file contains structural information
#' about a decoy structure (decoy2_180) that represents a different conformation
#' of the protein ILNIA. This structure was pre-generated by the 3DRobot program
#' developed by the Zhang Lab.
#'
#' @source 3DRobot_set from Zhang Lab \cr
