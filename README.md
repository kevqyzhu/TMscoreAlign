...
- [Su W, Johnston B (2021). *r3dmol: Create Interactive 3D
  Visualizations of Molecular Data*. R package version
  0.1.2](https://CRAN.R-project.org/package=r3dmol) -[Zhang, Y., and
  Skolnick, J. (2004). Scoring function for automated assessment \#’ of
  protein structure template quality. *Proteins, Structure, Function,
  and Bioinformatics*, 57(4),
